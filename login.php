            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  ...
                  <p class="mb-0">Insira seu usuario e senha para acessar a plataforma.</p>
                </div>
                <div class="card-body">
                <?php 
                                    
                    if(isset($_SESSION['login_error'])) {
                        echo "<div class='alert alert-danger text-white text-center' role='alert'><p>".$_SESSION['login_error']."</p></div>";
